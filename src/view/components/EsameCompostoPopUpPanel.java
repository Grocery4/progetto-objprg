...
public class EsameCompostoPopUpPanel extends JPanel implements ActionListener {
	...
	//Valori da memorizzare in quanto l'esame non viene spedito
	//in un unico tempo
	...
	public EsameCompostoPopUpPanel(View view) {
...
//			resetFormContent();
	...
	public void checkVotoValidity()throws InvalidRangeException, InvalidLodeException, NullInputsException {
